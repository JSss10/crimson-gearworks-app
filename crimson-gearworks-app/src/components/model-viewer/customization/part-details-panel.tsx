import CustomizationGroup from '@/components/model-viewer/customization/customization-group';
import { IoClose } from 'react-icons/io5';
import { useState } from 'react';
import type { CustomizationOption, ModelPart } from '@/types/model-types';
import styles from '@/styles/model-viewer/customization/part-details-panel.module.css';
