...
import styles from "@/styles/features/timeline-scroller.module.css";
...
export default function TimelineScroller() {
  ...
  return (
    <div ref={wrapperRef} className={styles.wrapper}>
      ...
      <div ref={timelineRef} className={styles.timeline} aria-label="Timeline navigation">
        {markers.map(i => (
          <div key={i} className={styles.marker} />
        ))}
        <div ref={scrollerRef} className={styles.scroller} role="slider" aria-valuemin={0} aria-valuemax={100} aria-valuenow={0}>
          <p>
            [<span>Drag</span>]
          </p>
        </div>
